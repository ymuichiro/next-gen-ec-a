  ...
  const t = {
    ...
    r = (...n) => {
      ...
      if ((n.length !== 0 && Ot.push([o, ...n]), Ot.length > fl && Ot.shift(), It.enabled(o) || i)) {
        const l = n.map((g) => (typeof g == "string" ? g : yl(g))),
          u = `+${Date.now() - Mi}ms`;
...
S.logarithm = S.log = function (e) {
  ...
  if (
    ...
    do
      if (((a += 10), (s = Ne(this, a)), (n = t ? dr(g, a + 10) : Ne(e, a)), (l = j(s, n, a, 1)), !o)) {
...
S.minus = S.sub = function (e) {
  ...
  if (((r = te(e.e / M)), (g = te(this.e / M)), (u = u.slice()), (o = g - r), o)) {
    for (
      h = o < 0,
...
S.plus = S.add = function (e) {
  ...
  if (((o = te(this.e / M)), (n = te(e.e / M)), (u = u.slice()), (i = o - n), i)) {
    for (
...
S.precision = S.sd = function (e) {
  ...
  return this.d ? ((t = lo(this.d)), e && this.e + 1 > t && (t = this.e + 1)) : (t = Number.NaN), t;
};
S.round = function () {
...
function O(e, t, r, n) {
  ...
  e: if (t != null) {
    ...
    if (
      ...
      return (
        (h.length = 0), u ? ((t -= e.e + 1), (h[0] = J(10, (M - (t % M)) % M)), (e.e = -t || 0)) : (h[0] = e.e = 0), e
      );
    if (
      (o == 0
        ? ((h.length = v), (a = 1), v--)
...
function Ne(e, t) {
  ...
  if (A.s < 0 || !I || !I[0] || (!A.e && I[0] == 1 && I.length == 1))
    return new F(I && !I[0] ? -1 / 0 : A.s != 1 ? Number.NaN : I ? 0 : A);
  if (
    (t == null ? ((_ = !1), (g = k)) : (g = t),
    (F.precision = g += C),
    (r = Y(I)),
...
me.stringify = (e, t) =>
  typeof e == "string" ? e : Array.isArray(e) ? e.map((r) => me.stringify(r, t)).join("") : Qu(e.type)(e.content);
function Qu(e) {
  return yo[e] || Uu;
}
function wo(e) {
...
function kc(e, t, r) {
  const n = {};
  return (
    e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Oc(n, t, e), Ic(n, r, e), n
  );
}
function Oc(e, t, r) {
...
var Vn = Symbol();
function Yt(e) {
  const t = [mp(e), fp(e), re(Vn, () => e), re("$parent", () => e._appliedParent)],
