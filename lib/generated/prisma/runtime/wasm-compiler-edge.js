...
function Zn(e, t) {
  ...
  if (t === "hex") {
    const r = new h(e.length / 2);
    for (let n = 0, i = 0; i < e.length; i += 2, n++) r[n] = Number.parseInt(e.slice(i, i + 2), 16);
    return r;
  }
  Io(`encoding "${t}"`);
}
function Yu(e) {
  const r = Object.getOwnPropertyNames(DataView.prototype).filter((d) => d.startsWith("get") || d.startsWith("set")),
    n = r.map((d) => d.replace("get", "read").replace("set", "write")),
    i = (d, f) =>
      function (T = 0) {
        return z(T, "offset"), pe(T, "offset"), Z(T, "offset", this.length - 1), new DataView(this.buffer)[r[d]](T, f);
      },
    o = (d, f) =>
      function (T, v = 0) {
        const A = r[d].match(/set(\w+\d+)/)[1].toLowerCase(),
          R = Xu[A];
        return (
          z(v, "offset"),
          pe(v, "offset"),
          ...
          v + Number.parseInt(r[d].match(/\d+/)[0]) / 8
        );
      },
    s = (d) => {
      d.forEach((f) => {
  ...
  n.forEach((d, f) => {
    d.startsWith("read") && ((e[d] = i(f, !1)), (e[d + "LE"] = i(f, !0)), (e[d + "BE"] = i(f, !1))),
      d.startsWith("write") && ((e[d] = o(f, !1)), (e[d + "LE"] = o(f, !0)), (e[d + "BE"] = o(f, !1))),
      s([d, d + "LE", d + "BE"]);
  });
}
function Io(e) {
...
function Z(e, t, r = nc + 1) {
  if (e < 0 || e > r) {
    const n = new RangeError(`The value of "${t}" is out of range. It must be >= 0 && <= ${r}. Received ${e}`);
    throw ((n.code = "ERR_OUT_OF_RANGE"), n);
  }
}
function z(e, t) {
  if (typeof e != "number") {
    const r = new TypeError(`The "${t}" argument must be of type number. Received type ${typeof e}.`);
    throw ((r.code = "ERR_INVALID_ARG_TYPE"), r);
  }
}
function pe(e, t) {
  if (!Number.isInteger(e) || Number.isNaN(e)) {
    const r = new RangeError(`The value of "${t}" is out of range. It must be an integer. Received ${e}`);
    throw ((r.code = "ERR_OUT_OF_RANGE"), r);
  }
}
function Zu(e, t, r, n) {
  if (e < r || e > n) {
    const i = new RangeError(`The value of "${t}" is out of range. It must be >= ${r} and <= ${n}. Received ${e}`);
    throw ((i.code = "ERR_OUT_OF_RANGE"), i);
  }
}
function So(e, t) {
  if (typeof e != "string") {
    const r = new TypeError(`The "${t}" argument must be of type string. Received type ${typeof e}`);
    throw ((r.code = "ERR_INVALID_ARG_TYPE"), r);
  }
}
  ...
  l = fe(() => {
    h = class e extends Uint8Array {
      ...
      copy(t, r = 0, n = 0, i = this.length) {
        ...
        let o = 0;
        while (n < i && !(this[n] === void 0 || t[r] === void 0)) (t[r] = this[n]), o++, n++, r++;
        return o;
      }
      write(t, r, n, i = "utf8") {
        ...
        return (
          ...
          s.length === 0 && i === !1
            ...
            : s.length === 0 && i === !0
              ...
              : o((f, T) => (i ? T <= d : T >= d) && this[T] === s[0] && s.every((A, R) => this[T + R] === A))
        );
      }
      toString(t = "utf8", r = 0, n = this.length) {
        ...
        if (t === "base64" || t === "base64url") {
          const i = btoa(this.reduce((o, s) => o + Xn(s), ""));
...
function ve(e) {
  var t,
    ...
    s = e[0];
  if (i > 0) {
    for (o += s, t = 1; t < i; t++) (n = e[t] + ""), (r = j - n.length), r && (o += Ue(r)), (o += n);
...
function Mo(e, t) {
  ...
  for (t == null ? ((G = !1), (d = A)) : (d = t), s = new v(0.03125); e.abs().gte(0.1); ) (e = e.times(s)), (T += 5);
  for (n = ((Math.log(We(2, T)) / Math.LN10) * 2 + 5) | 0, d += n, r = i = o = new v(ge), v.precision = d; ; ) {
    if (
      ((i = $(i.times(e), d)),
      (r = r.times(++f)),
      (s = o.plus(De(i, r, d))),
...
function ei(e, t, r) {
  if (t > e.LN10.sd()) throw ((G = !0), r && (e.precision = r), Error(he + "LN10 precision limit exceeded"));
...
function qt(e, t) {
  ...
  if ((t == null ? ((G = !1), (T = M)) : (T = t), C.eq(10))) return t == null && (G = !0), ei(I, T);
  if (((T += R), (I.precision = T), (r = ve(D)), (n = r.charAt(0)), (o = Y(C)), Math.abs(o) < 15e14)) {
    while ((n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3)) (C = C.times(e)), (r = ve(C.d)), (n = r.charAt(0)), A++;
...
function $(e, t, r) {
  ...
  if (
    ...
    return (
      f
        ? ((o = Y(e)), (A.length = 1), (t = t - o - 1), (A[0] = We(10, (j - (t % j)) % j)), (e.e = pt(-t / j) || 0))
  ...
  if (
    (n == 0
      ? ((A.length = v), (o = 1), v--)
      : ((A.length = v + 1), (o = We(10, j - n)), (A[v] = i > 0 ? (((T / We(10, s - i)) % We(10, i)) | 0) * o : 0)),
    f)
  )
    for (;;)
      if (v == 0) {
...
function No(e, t) {
  ...
  for (v && ((r = f), (f = A), (A = r), (t.s = -t.s)), d = f.length, i = A.length - d; i > 0; --i) f[d++] = 0;
  for (i = A.length; i > s; ) {
    if (f[--i] < A[i]) {
...
function Lo(e) {
  ...
  function i(o) {
    ...
    if (typeof o == "number") {
      ...
      return Oo(this, o.toString());
    } else if (typeof o != "string") throw Error(Ke + o);
    if ((o.charCodeAt(0) === 45 ? ((o = o.slice(1)), (this.s = -1)) : (this.s = 1), sc.test(o))) Oo(this, o);
...
var ct,
  ...
  Uo = fe(() => {
    ...
    S.dividedToIntegerBy = S.idiv = function (e) {
      ...
      return $(De(this, new r(e), 0, 1), r.precision);
    };
    ...
    S.logarithm = S.log = function (e) {
      ...
      return this.eq(ge) ? new n(0) : ((G = !1), (t = De(qt(this, o), qt(e, o), o)), (G = !0), $(t, i));
    };
    S.minus = S.sub = function (e) {
      return (e = new this.constructor(e)), this.s == e.s ? No(this, e) : _o(this, ((e.s = -e.s), e));
    };
    S.modulo = S.mod = function (e) {
      ...
      return this.s ? ((G = !1), (t = De(this, e, 0, 1).times(e)), (G = !0), this.minus(t)) : $(new n(this), i);
    };
    ...
    S.plus = S.add = function (e) {
      return (e = new this.constructor(e)), this.s == e.s ? _o(this, e) : No(this, ((e.s = -e.s), e));
    };
    S.precision = S.sd = function (e) {
      var t, r, n;
      if (e !== void 0 && e !== !!e && e !== 1 && e !== 0) throw Error(Ke + e);
      if (((t = Y(this) + 1), (n = this.d.length - 1), (r = n * j + 1), (n = this.d[n]), n)) {
        for (; n % 10 == 0; n /= 10) r--;
    ...
    S.squareRoot = S.sqrt = function () {
      ...
      for (
        ...
        if (((o = n), (n = o.plus(De(this, o, s + 2)).times(0.5)), ve(o.d).slice(0, s) === (t = ve(n.d)).slice(0, s))) {
    ...
    S.toDecimalPlaces = S.todp = function (e, t) {
      ...
      return (
        (r = new n(r)),
        e === void 0 ? r : (Ae(e, 0, ct), t === void 0 ? (t = n.rounding) : Ae(t, 0, 8), $(r, e + Y(r) + 1, t))
      );
    };
    ...
    De = (() => {
      ...
      return (n, i, o, s) => {
        ...
        for (f = n.e - i.e, Ee = K.length, Je = Te.length, C = new jr(Gu), D = C.d = [], T = 0; K[T] == (Te[T] || 0); )
          ++T;
        if (
          (K[T] > (Te[T] || 0) && --f,
            ...
            (v = 0),
              ...
              d < 0
                ? ((be = I[0]),
                  ...
                  R < M && A.unshift(0),
                  r(I, A, M),
                  d == -1 && ((M = I.length), (d = t(K, I, Ee, M)), d < 1 && (v++, r(I, Ee < M ? Br : K, M))),
                  (M = I.length))
                : d === 0 && (v++, (I = [0])),
              (D[T++] = v),
...
var P,
  ...
  a = fe(() => {
    ...
    (P = class extends Jr {
      ...
      static random(t = 20) {
        {
          const n = globalThis.crypto.getRandomValues(new Uint8Array(t)).reduce((i, o) => i + o, "");
...
var yl = se((U) => {
  ...
  function qm(e) {
    const t = (n, i) => e(i).update(Dn(n)).digest(),
      r = e({});
...
var vl = se((Q) => {
  ...
  var Tl = (e, t, r) =>
    (0, Ne.wrapXOFConstructorWithOpts)((n = {}) => new hr(t, e, n.dkLen === void 0 ? r : n.dkLen, !0));
...
var lc = {
  enabled: !qo && Bo == null && jo !== "dumb" && ((oi != null && oi !== "0") || Qo),
};
function q(e, t) {
  const r = new RegExp(`\\x1b\\[${t}m`, "g"),
    n = `\x1B[${e}m`,
    i = `\x1B[${t}m`;
  return (o) => (!lc.enabled || o == null ? o : n + (~("" + o).indexOf(i) ? o.replace(r, i + n) : o) + i);
}
var ng = q(0, 0),
  Wr = q(1, 22),
  Kr = q(2, 22),
...
function pc(e) {
  const t = {
    ...
    r = (...n) => {
      const { enabled: i, namespace: o, color: s, log: d } = t;
      if ((n.length !== 0 && Bt.push([o, ...n]), Bt.length > uc && Bt.shift(), jt.enabled(o) || i)) {
        const f = n.map((v) => (typeof v == "string" ? v : mc(v))),
          T = `+${Date.now() - Yo}ms`;
        (Yo = Date.now()), d(o, ...f, T);
      }
    };
...
function Wc({ functionName: e, location: t, message: r, isPanic: n, contextLines: i, callArguments: o }, s) {
  ...
  if (
    (n
      ? (d.push(s.red(`Oops, an unknown error occurred! This is ${s.bold("on us")}, you did nothing wrong.`)),
...
function on(e) {
  let t = e.showColors ? Gc : Hc,
    r;
  return typeof $getTemplateParameters < "u" ? (r = $getTemplateParameters(e, t)) : (r = Jc(e)), Wc(r, t);
}
l();
u();
c();
...
var xt = class e extends Ve {
  ...
  getDeepField(t) {
    ...
    for (const s of n) {
      let d;
      if (
        (o.value instanceof e ? (d = o.value.getField(s)) : o.value instanceof Et && (d = o.value.getField(Number(s))),
        !d)
      )
        return;
      o = d;
...
function ep(e, t) {
  ...
  if (o && (o.getField(n)?.markAsError(), i))
    for (const s of i.fields) s.isRelation && o.addSuggestion(new ye(s.name, "true"));
  t.addErrorMessage((s) => {
...
function up(e, t) {
  ...
  if (d)
    if (((r = d.getField(o)), r && d.removeField(o), e.inputTypes.length === 1 && e.inputTypes[0].kind === "object")) {
      for (const f of e.inputTypes[0].fields) s.addField(f.name, f.typeNames.join(" | "));
      d.addSuggestion(new ye(o, s).makeRequired());
    } else {
      const f = e.inputTypes.map(Ds).join(" | ");
...
function _s(e, t) {
  for (const r of t.fields) e.hasField(r.name) || e.addSuggestion(new ye(r.name, "true"));
}
function gp(e, t) {
  for (const r of t.fields) r.isRelation && !e.hasField(r.name) && e.addSuggestion(new ye(r.name, "true"));
}
function yp(e, t) {
  for (const r of t.fields) !e.hasField(r.name) && !r.isRelation && e.addSuggestion(new ye(r.name, "true"));
}
function hp(e, t) {
  for (const r of t) e.hasField(r.name) || e.addSuggestion(new ye(r.name, r.typeNames.join(" | ")));
}
function Ms(e, t) {
  const [r, n] = Xt(e),
...
function Ns(e, t) {
  if (t.kind === "object")
    for (const r of t.fields) e.hasField(r.name) || e.addSuggestion(new ye(r.name, r.typeNames.join(" | ")));
}
function Xt(e) {
  const t = [...e],
    r = t.pop();
...
var Ls = ": ",
  dn = class {
    ...
    write(t) {
      ...
      this.hasError && r.underline().setColor(t.context.colors.red), t.write(r).write(Ls).write(this.value);
    }
  };
var bi = class {
  arguments;
...
function Fs(e) {
  ...
  if (e instanceof Date) {
    const t = nn(e) ? e.toISOString() : "Invalid Date";
...
function Ep(e) {
  const t = new Et();
  for (const r of e) t.addItem(Fs(r));
  return t;
}
function fn(e, t) {
  const r = t === "pretty" ? Is : un,
...
function gn({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  const d = Tt(e);
  for (const A of t) sn(A, d, s);
  const { message: f, args: T } = fn(d, r),
    v = on({
      message: f,
      callsite: n,
      originalMethod: i,
...
function Ap(e, t, r) {
  const n = {};
  return (
    e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Cp(n, t, e), Rp(n, r, e), n
  );
}
function Cp(e, t, r) {
...
var me = class e {
  constructor(t, r) {
    ...
    const n = r.reduce((s, d) => s + (d instanceof e ? d.values.length : 1), 0);
...
function Pe(e, t) {
  const r = Mp(t),
    ...
    i = new Proxy(e, {
      ...
      ownKeys(o) {
        const s = na(Reflect.ownKeys(o), r),
          d = na(Array.from(r.keys()), r);
        return [...new Set([...s, ...d, ...n])];
      },
      set(o, s, d) {
        return r.get(s)?.getPropertyDescriptor?.(s)?.writable === !1 ? !1 : (n.add(s), Reflect.set(o, s, d));
      },
...
function qe(e) {
  return typeof $EnabledCallSite == "function" && e !== "minimal" ? new $EnabledCallSite() : new Ci();
}
l();
u();
c();
...
function St(e = {}) {
  const t = Fp(e);
  return Object.entries(t).reduce((n, [i, o]) => (oa[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), {
    select: {},
  });
}
function Fp(e = {}) {
...
var pa = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  ma = (e, t, r) => pa(t).reduceRight((n, i, o, s) => Object.assign({}, Ri(e, s.slice(0, o)), { [i]: n }), r);
function jp(e, t) {
...
function Si(e, t, r, n, i, o) {
  const d = e._runtimeDataModel.models[t].fields.reduce((f, T) => ({ ...f, [T.name]: T }), {});
  return (f) => {
    const T = qe(e._errorFormat),
      v = jp(n, i),
      A = Qp(f, o, v),
...
function Ii(e, t) {
  const r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [Wp(e, t), zp(e, t), ur(r), le("name", () => t), le("$name", () => t), le("$parent", () => e._appliedParent)];
  return Pe({}, n);
}
function Wp(e, t) {
  const r = Se(t),
...
var Oi = Symbol();
function cr(e) {
  const t = [Yp(e), Zp(e), le(Oi, () => e), le("$parent", () => e._appliedParent)],
...
function ya({ result: e, modelName: t, select: r, omit: n, extensions: i }) {
  ...
  for (const f of Object.values(o)) {
    if (n) {
      ...
      const T = f.needs.filter((v) => n[v]);
      T.length > 0 && d.push(Ct(T));
    } else if (r) {
      if (!r[f.name]) continue;
      const T = f.needs.filter((v) => !r[v]);
      T.length > 0 && d.push(Ct(T));
    }
...
function wa({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
    ...
    return (
      ...
      n === r.length
        ...
        : r[n]({
            ...
            __internalParams: t,
            query: (s, d = t) => {
              const f = d.customDataProxyFetch;
...
function Fa(e, t, r) {
  switch (t.type) {
    case "AffectedRows":
      if (typeof e != "number") throw new H(`Expected an affected rows count, got: ${typeof e} (${e})`);
      return { count: e };
    case "Object":
...
function Mi(e, t, r, n) {
  ...
  switch (r.type) {
    case "Any":
      return e;
    case "String": {
      if (typeof e != "string") throw new H(`Expected a string in column '${t}', got ${typeof e}: ${e}`);
      return e;
    }
    case "Int":
      switch (typeof e) {
...
var qa = 2,
  ...
  bm = Xe(
    Ba.split("")
      .reduce((e, t) => +e + t.charCodeAt(0), +wm + 36)
      .toString(36),
    qa
  );
function Ui() {
...
function dd(e, t = Ul) {
  ...
  if (e > Nl) throw new nt(rt.EncodeTimeSizeExceeded, `Cannot encode a time larger than ${Nl}: ${e}`);
  if (e < 0) throw new nt(rt.EncodeTimeNegative, `Time must be positive: ${e}`);
  if (Number.isInteger(e) === !1) throw new nt(rt.EncodeTimeValueMalformed, `Time must be an integer: ${e}`);
  let r,
    n = "";
...
function Jl(e) {
  const r = e.columnTypes
    ...
    .map((n) => {
      switch (n) {
        case "int":
          return (i) => (i === null ? null : typeof i == "number" ? i : Number.parseInt(`${i}`, 10));
        case "bigint":
...
var _t = class e {
  ...
  async run(t, r) {
    const { value: n } = await this.interpretNode(t, r, this.#r, this.#o.snapshot(r.provider)).catch((i) => $a(i));
    return n;
  }
    ...
    switch (t.type) {
      ...
      case "let": {
        ...
        for (const s of t.args.bindings) {
          const { value: d } = await this.interpretNode(s.expr, r, o, i);
          o[s.name] = d;
        }
      ...
      case "concat": {
        const o = await Promise.all(t.args.map((s) => this.interpretNode(s, r, n, i).then((d) => d.value)));
        return {
      ...
      case "reverse": {
        const { value: o, lastInsertId: s } = await this.interpretNode(t.args, r, n, i);
      ...
      case "mapField": {
        const { value: o, lastInsertId: s } = await this.interpretNode(t.args.records, r, n, i);
        return { value: tu(o, t.args.field), lastInsertId: s };
      }
      case "join": {
        const { value: o, lastInsertId: s } = await this.interpretNode(t.args.parent, r, n, i);
      ...
      case "transaction": {
        ...
        try {
          const f = await this.interpretNode(t.args, d, n, i);
      ...
      case "dataMap": {
        const { value: o, lastInsertId: s } = await this.interpretNode(t.args.expr, r, n, i);
        return {
      ...
      case "extendRecord": {
        const { value: o, lastInsertId: s } = await this.interpretNode(t.args.expr, r, n, i),
          d = o === null ? {} : Tr(o);
        for (const [f, T] of Object.entries(t.args.values))
...
function tu(e, t) {
  return Array.isArray(e) ? e.map((r) => tu(r, t)) : typeof e == "object" && e !== null ? (e[t] ?? null) : e;
}
function Yl(e, t) {
  for (const { joinExpr: r, childRecords: n } of t) e[r.parentField] = Td(n, e, r);
  return e;
}
function Td(e, t, r) {
  if (Array.isArray(e)) {
    const n = e.filter((i) => Zl(Tr(i), t, r));
...
function Zl(e, t, r) {
  for (const [n, i] of r.on) if (t[n] !== e[i]) return !1;
  return !0;
}
function Xl(e, { cursor: t, skip: r, take: n }) {
  const i = t !== null ? e.findIndex((d) => mr(d, t)) : 0;
  if (i === -1) return [];
  const o = i + (r ?? 0),
...
var Ad = 100,
  ...
  Cr = class {
    ...
    async #r(t) {
      ...
      const i = await this.driverAdapter.startTransaction(r.isolationLevel);
      switch (n.status) {
        case "waiting":
          return (
            (n.transaction = i),
        ...
        case "committed":
        case "rolled_back":
          throw new Mt(`Transaction in invalid state ${n.status} although it just finished startup.`);
        default:
...
var co,
  nu = {
    async loadQueryCompiler(e) {
      ...
      if (r === void 0)
        throw new L(`The \`adapter\` option for \`PrismaClient\` is required in this context (${Be().prettyName})`, t);
...
var Rr = class {
  ...
  async instantiateQueryCompiler() {
    ...
    const r = (await this.adapterPromise)?.getConnectionInfo?.() ?? {};
    try {
      this.#n(() => {
...
${r.backtrace}`,
  ...
  async request(t, { traceparent: r, interactiveTransaction: n }) {
    ...
    try {
      ...
      const T = n ? s.getTransaction(n, "query") : o,
  ...
  #s(t, r, n) {
    const i = t.map((s) => r.keys.reduce((d, f) => ((d[f] = Fe(s[f])), d), {})),
      o = new Set(r.nestedSelection);
    return r.arguments.map((s) => {
      const d = i.findIndex((f) => mr(f, s));
      if (d === -1)
        return r.expectNonEmpty
          ...
          : { data: { [n]: null } };
      {
        const f = Object.entries(t[d]).filter(([T]) => o.has(T));
...
function Nt({ inlineDatasources: e, overrideDatasources: t, env: r, clientVersion: n }) {
  let i,
    ...
    d = t[o]?.url;
  if (
    (o === void 0 ? (i = void 0) : d ? (i = d) : s?.value ? (i = s.value) : s?.fromEnvVar && (i = r[s.fromEnvVar]),
...
async function at(e, t, r = (n) => n) {
  ...
  try {
    ...
    const d = s.message ?? "Unknown error";
...
async function Ud(e, t) {
  const r = cu["@prisma/engines-version"],
  ...
  qr = class {
    ...
    async uploadSchema() {
      ...
      return this.tracingHelper.runInChildSpan(t, async () => {
        const r = await at(await this.url("schema"), {
          method: "PUT",
        ...
        const n = await Fr(r, this.clientVersion);
        if (n)
          throw (
    ...
    requestInternal({ body: t, traceparent: r, customDataProxyFetch: n, interactiveTransaction: i }) {
      return this.withRetry({
        ...
        callback: async ({ logHttpCall: o }) => {
          ...
          d.ok || Vr("graphql response status", d.status), await this.handleError(await Fr(d, this.clientVersion));
...
function fu({ copyEngine: e = !0 }, t) {
  ...
  const n = !!(r?.startsWith("prisma://") || tn(r));
  e &&
    n &&
    Wt(
      "recommend--no-engine",
...
function Eu(e) {
  ...
  const t = {};
  for (const r of Object.keys(e)) t[r] = wu(e[r]);
  return t;
}
function wu(e) {
...
var xo =
    ...
    (r) => {
      ...
      return i?.values ? xu(`prisma.${e}(${n}, ${i.values})`) : xu(`prisma.${e}(${n})`), { query: n, parameters: i };
    },
  Pu = {
...
var qd = ai.split(".")[0],
  ...
  To = class {
    ...
    getGlobalTracingHelper() {
      const t = globalThis[`V${qd}_PRISMA_INSTRUMENTATION`],
  ...
  zn = class {
      ...
      (this.logEmitter = r),
        ...
        (this.dataloader = new Wn({
          ...
          singleLoader: async (n) => {
            const i = n.transaction?.kind === "itx" ? Ou(n.transaction) : void 0,
          ...
          batchBy: (n) => (n.transaction?.id ? `transaction-${n.transaction.id}` : Su(n.protocolQuery)),
          batchOrder(n, i) {
    ...
    async request(t) {
      try {
        ...
        const { clientMethod: n, callsite: i, transaction: o, args: s, modelName: d } = t;
    ...
    handleRequestError({
      ...
      if (
        ...
        const T = s ? { modelName: s, ...t.meta } : t.meta;
        throw new X(f, {
          code: t.code,
          clientVersion: this.client._clientVersion,
          meta: T,
...
var _u = ["datasources", "datasourceUrl", "errorFormat", "adapter", "log", "transactionOptions", "omit", "__internal"],
...
Expected string or undefined.`);
    ...
    omit: (e, t) => {
      ...
      for (const [n, i] of Object.entries(e)) {
        const o = Yd(n, t.runtimeDataModel);
        if (!o) {
          r.push({ kind: "UnknownModel", modelKey: n });
          continue;
        }
        for (const [s, d] of Object.entries(i)) {
          const f = o.fields.find((T) => T.name === s);
          if (!f) {
...
function zd(e, t) {
  ...
  const r = t.map((i) => ({ value: i, distance: (0, Uu.default)(e, i) }));
...
function Lu(e, t) {
  const r = Object.keys(e).find((n) => $e(n) === t);
  if (r) return e[r];
}
function Zd(e, t) {
  const r = Tt(e);
  ...
  const { message: n, args: i } = fn(r, "colorless");
...
function Bu(e) {
  class t {
    ...
    constructor(n) {
      ...
      if (n?.adapter) {
        s = n.adapter;
        const f = e.activeProvider === "postgresql" ? "postgres" : e.activeProvider;
        if (s.provider !== f)
          throw new L(
      ...
      try {
        ...
        if (
          ...
          for (const C of f.log) {
            const D = typeof C == "string" ? C : C.emit === "stdout" ? C.level : null;
            D &&
              this.$on(D, (I) => {
    ...
    $queryRaw(n, ...i) {
      return this._createPrismaPromise((o) => {
        if (n.raw !== void 0 || n.sql !== void 0) return this.$queryRawInternal(o, "$queryRaw", ...Vu(n, i));
        throw new ne(
    ...
    _transactionWithArray({ promises: n, options: i }) {
      const o = tf.nextId(),
        ...
        d = n.map((f, T) => {
          ...
          const v = i?.isolationLevel ?? this._engineConfig.transactionOptions.isolationLevel,
