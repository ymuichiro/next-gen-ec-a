...
`
  ...
  function ks(e) {
    ...
    if (e && e.path && e.path.length > 0)
      if (Array.isArray(e.path))
        for (const t of e.path) _i.existsSync(t) && (r = t.endsWith(".vault") ? t : `${t}.vault`);
  ...
  function pp(e) {
    ...
    for (const l of i)
      try {
        const u = B.parse(_i.readFileSync(l, { encoding: t }));
        B.populate(s, u, e);
      } catch (u) {
  ...
  function mp(e, r) {
    ...
    n = n.subarray(12, -16);
    try {
      const s = np.createDecipheriv("aes-256-gcm", t, i);
...
async function Xu() {
  ...
  try {
    const r = await pi.default.readFile(e, { encoding: "utf-8" });
    return Zu(r);
  } catch {
    return {
      targetDistro: void 0,
...
function gp(e, r, t) {
  ...
  if (n && r && i && sn.default.existsSync(r)) {
    const o = Fi.default.parse(sn.default.readFileSync(r)),
      s = [];
...
m.logarithm = m.log = function (e) {
  ...
  if (
    ...
    do
      if (((a += 10), (s = Je(this, a)), (n = r ? mn(c, a + 10) : Je(e, a)), (l = L(s, n, a, 1)), !o)) {
...
var L = (() => {
  ...
  return (n, i, o, s, a, l) => {
    ...
    if (!K || !K[0] || !_ || !_[0])
      return new jt(
        !n.s || !i.s || (K ? _ && K[0] == _[0] : !_) ? Number.NaN : (K && K[0] == 0) || !_ ? ei * 0 : ei / 0
      );
    for (
...
function Je(e, r) {
  ...
  if (h.s < 0 || !I || !I[0] || (!h.e && I[0] == 1 && I.length == 1))
    return new v(I && !I[0] ? -1 / 0 : h.s != 1 ? Number.NaN : I ? 0 : h);
  if (
    (r == null ? ((w = !1), (c = b)) : (c = r),
    (v.precision = c += g),
    (t = J(I)),
  ...
  function i(o) {
    ...
    if (l === "string")
      return (
        ...
        Gs.test(o) ? cn(this, o) : vp(this, o)
      );
    if (l === "bigint") return o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), cn(this, o.toString());
    throw Error(He + o);
  }
  if (
    ((i.prototype = m),
      ...
      for (const h in t) {
        ...
        for (let v = 0; v < I.length; ++v) {
          ...
          for (let V = n, te = i; V < r.length; te += r[V].length, ++V) {
            ...
            const fr = new ge(h, b ? P.tokenize(p, b) : p, Jr, p, me);
            if (
              (H.push(fr),
              g && H.push(g),
...
var Ll = {
  async loadLibrary(e) {
    ...
    try {
      ...
      const i = Ti({ e: n, platformInfo: r, id: t });
...
function $l({ copyEngine: e = !0 }, r) {
  ...
  const n = !!(t?.startsWith("prisma://") || nn(t));
  e &&
    n &&
    st(
      "recommend--no-engine",
      ...
      (this.logEmitter = t),
        ...
        (this.dataloader = new Yn({
          ...
          singleLoader: async (n) => {
            const i = n.transaction?.kind === "itx" ? eu(n.transaction) : void 0,
...
function gu(e) {
  class r {
    ...
    constructor(n) {
      ...
      const a = (!s && o && ot(o, { conflictCheck: "none" })) || e.injectableEdgeEnv?.();
      try {
        const l = n ?? {},
          u = l.__internal ?? {},
          c = u.debug === !0;
